...
function prom_xml_importer_settings_page() {
	?>
	<div class="wrap">
		<h1><?php esc_html_e( 'Prom XML Importer Settings', 'xml-prom' ); ?></h1>
...
function prom_xml_importer_settings_init() {
	...
	add_settings_section(
		...
		__( 'Основні налаштування', 'xml-prom' ),
		null,
		'prom-xml-importer'
	);
	...
	add_settings_field(
		...
		__( 'Інтервал оновлення', 'xml-prom' ),
